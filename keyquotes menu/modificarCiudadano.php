...
@$ape=$_POST['apellido'];
@$ge=$_POST['genero'];
@$fec=$_POST['fecha_vencimiento'];
@$dir=$_POST['direccion'];
@$dep=$_POST['depto'];
@$mun=$_POST['municipio'];

$sql="INSERT INTO votante (dui,nombre,apellido,genero,imagen,fecha_vencimiento,direccion,departamento,municipio) values ('$du','$nom','$ape','$ge','$rutaDestino','$fec','$dir','$dep','$mun')";
