...
if(d.valant != d.value){
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorCiudadano.php?accion=save" method="post" id="alumno" enctype="multipart/form-data">
            ...
            <div class="col-xs-2">
                <input type="text" name="apellido" value='<?php print $datos[0][3] ?>' class="required form-control">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                <input type="text" name="nombre" value='<?php print $datos[0][2] ?>' class="required form-control">
            </div>
            </div>
    <br>        
            <div class="row">
