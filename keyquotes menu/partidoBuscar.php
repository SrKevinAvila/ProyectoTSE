    ...
    <div class="jumbotron">
        ...
        <form action="manejadorPartido.php?accion=save" method="post" id="alumno" enctype="multipart/form-data">
            ...
            <div class="col-xs-2">
                    ...
                    <input type="text" name="nombre" placeholder="FMLN" value='<?php print $datos[0][1] ?>' class="required form-control">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                    <input type="file" name="imagen" value='<?php print $datos[0][2] ?>' >
            </div>
            </div>
    <br>        
            <div class="row">
