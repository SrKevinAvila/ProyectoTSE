...
if(d.valant != d.value){
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorCandidato.php?accion=save" method="post" id="candidato">
            ...
            <div class="col-xs-2">
                    <input type="text" name="apellido" placeholder="Sanchez Ramos" value='<?php print $datos[0][3] ?>' class="required form-control">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                    <input type="text" name="nombre" placeholder="David Enrique" value='<?php print $datos[0][2] ?>' class="required form-control">
            </div>
            </div>
    <br>
            <div class="row">
            <div class="col-xs-2">  
                ...
                <div class="col-xs-2">  
                <input type="hidden" name="dui" onkeypress="return solonumeros(event)" onpaste="return false" value='<?php print $datos[0][0] ?>'>
    ...
    <br>
            ...
            <div class="col-xs-2">
                <select name='cargos' value='<?php print $datos[0][5] ?>' class="required form-control">
                    <option value="">[seleccionar]</option>
