...
?>
<?php $sql = "SELECT * FROM partido WHERE id = '".$_REQUEST['id']."';";
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorPartido.php?accion=save" method="post" id="alumno" enctype="multipart/form-data">
            ...
            <div class="col-xs-2">
                    ...
                    <input type="text" name="nombre" name "letras" placeholder="FMLN" value='<?php print $datos[0][1] ?>' class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                    <input type="file" name="imagen" name"letras" value='<?php print $datos[0][2] ?>' class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">  
                <input type="text" name="dui" onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);" maxlength="10" placeholder="00000000-0" value='<?php print $datos[0][3] ?>' class="required form-control">
            </div>
            </div>
    <br>        
            <div class="row">
            <div class="col-xs-2">  
                ...
                <div class="col-xs-2">  
                    <input type="text" name="presidente" value='<?php print $datos[0][4] ?>' class="required form-control">
                </div>
                </div>
    <BR>
            <div class="row">
