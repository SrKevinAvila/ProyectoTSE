...
if(d.valant != d.value){
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorCandidato.php?accion=save" method="post" id="candidato">
            ...
            <div class="col-xs-2">
                    <input type="text" name="nombre" name"letras" placeholder="Sanchez Ramos" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                    <input type="text" name="apellido" name"letras" placeholder="David Enrique" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>
            <div class="row">
