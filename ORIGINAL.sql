...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2015 a las 21:12:36
...
CREATE TABLE IF NOT EXISTS `coalicion` (
  ...
  `partido2` int(60) NOT NULL,
  `partido3` int(11) NOT NULL
...
INSERT INTO `voto_diputado` (`id_diputado`, `cod_candidato`, `cod_departamento`, `clicks`) VALUES
(0, 2, 2, 3),
(1, 2, 2, 3);
...
INSERT INTO `voto_presidente` (`id_presidente`, `cod_candidato`, `clicks`) VALUES
(1, 3, 4),
(2, 2, 4),
(3, 2, 6);
