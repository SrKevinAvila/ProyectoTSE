...
if(d.valant != d.value){
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorPartido.php?accion=save" method="post" id="alumno" enctype="multipart/form-data">
            ...
            <div class="col-xs-2">
                    <input type="text" name="nombre" name"letras" placeholder="FMLN" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
    ...
    <br>        
            ...
            <div class="col-xs-2">  
                <input type="text" name="dui" onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);" maxlength="10" placeholder="00000000-0" class="required form-control" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
            <div class="col-xs-2">  
                ...
                <div class="col-xs-2">  
                    <input type="text" name="presidente" name"letras" class="required form-control" onkeypress="return sololetras(event)">
                </div>
                </div>
    <BR>
            <div class="row">
