...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2015 a las 21:10:30
...
INSERT INTO `ciudadano` (`id`, `apellido`, `nombre`, `dui`, `fotografia`, `genero`, `vencimiento`, `direccion`, `depto`, `municipio`) VALUES
(3, 'Sanchez Martinez', 'David Enrique', '97896789-6', 'fotos/InuYasha.jpg', 'masculino', '2015-06-12', ' a la par de mi casa', '07', '0703'),
(4, 'Sanchez Martinez', 'David Enrique', '98789899-9', 'fotos/photo_storyf6dc509d069540336458bcc07dd1a01a.', 'masculino', '2015-05-02', ' EN MI CASA', '10', '1001');
...
`id` int(11) NOT NULL,
  ...
  `diputados` varchar(40) DEFAULT NULL,
  `anio` varchar(40) DEFAULT NULL
...
INSERT INTO `elecciones` (`id`, `presidente`, `alcalde`, `diputados`, `anio`) VALUES
(1, '', '', '', '2015'),
(2, '', '', '', '2015'),
(3, '', '', '', '2015'),
(4, '', '', '', '2015'),
(5, '', 'Alcalde', '', '2015'),
(6, '', 'Alcalde', 'Diputados', '2015'),
(7, 'Presidente', 'Alcalde', 'Diputados', '2015'),
(8, 'Presidente', '', 'Diputados', '2015'),
(9, '', 'Alcalde', '', '2015'),
(10, 'P', '', '', '2015'),
(11, 'P', '', 'D', '2015');
...
INSERT INTO `partido` (`id`, `nombre`, `bandera`, `dui`, `presidente`) VALUES
