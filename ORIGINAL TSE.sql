...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2015 a las 05:09:21
...
CREATE TABLE IF NOT EXISTS `coalision` (
  ...
  `municipio` varchar(150) DEFAULT NULL,
  `partidos` varchar(150) DEFAULT NULL
...
INSERT INTO `voto_alcalde` (`id_voto`, `cod_partido`, `cod_municipio`, `cod_departamento`, `clicks`) VALUES
(1, 1, 0, 0, 2),
(2, 0, 0, 0, 4),
(3, 4, 1, 1, 6);
