...
if(d.valant != d.value){
    ...
    <div class="jumbotron">
        ...
        <form action="manejadorCiudadano.php?accion=save" method="post" id="alumno" enctype="multipart/form-data">
            ...
            <div class="col-xs-2">
                <input type="text" name="apellido" name"letras" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
            ...
            <div class="col-xs-2">
                <input type="text" name="nombre" name"letras" class="required form-control" onkeypress="return sololetras(event)" onpaste="return false">
            </div>
            </div>
    <br>        
            <div class="row">
    ...
    <br>        
            ...
            <div class="input-group">
                <select name='genero' class="required form-control">
    ...
    <br>        
            ...
            <div class="col-xs-2">  
                <textarea rows="5" cols="30" name="direccion" id="direccion" class="required form-control" > </textarea>
            </div>
            </div>
    <br>        
            <div class="row">
